...
z_vectors1 = [z(1); z(2)];  %transverse dynamics
z_vectors2 = [-z(2); z(1)]; 
z_vectors = [z_vectors1 z_vectors2];
...
R = z_vectors; %just to get the correct size
...
zeta_vectors = z; %vectors of the transv. coord. system zeta_i = zeta_vectors(:,i)
