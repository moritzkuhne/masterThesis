function [dx_transverse_nom,dx_transverse_den] = transverseDynamics(system,x,tau,x_transverse)
...
dtau_nom = z.'*system(tau,(x+PI.'*x_transverse));
dtau_den = z.'*system(tau,x);


dx_transverse_sum1 = PI*system(tau,(x+PI.'*x_transverse));
dx_transverse_sum2 = -PI*system(tau,x)*dtau_nom;
dx_transverse_nom = dx_transverse_sum1 + dx_transverse_sum2;

dx_transverse_den = dtau_den;
